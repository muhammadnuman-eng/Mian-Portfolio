...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden px-4 py-8"
    >
      <div className={`flex flex-col lg:flex-row items-center justify-between gap-8 fade-in-up ${isVisible ? "visible" : ""} relative max-w-[100%] w-full mx-auto bg-card rounded-lg p-10 shadow-xl overflow-hidden`} style={{ animationDelay: "0.2s" }}>
        {/* Left Content */}
        <div className="flex flex-col justify-center space-y-8 flex-1 relative z-10">
          ...
          {/* Description */}
          <p className="text-foreground/70 text-base sm:text-lg max-w-2xl leading-relaxed relative z-10">
            I am a <span className="font-bold text-foreground">Full Stack Developer</span> at heart and, i create features that are best suited for the job at hand.
          </p>
